                    ...
                    <div class="col-6 border border-dark mt-5 shadow rounded-8">
                        <div class="p-5 d-flex justify-content-center">
                            <div class="text-center container align-content-center">
                                ...
                                <input class="form-control form-control-lg rounded-8 mt-5" type="text" placeholder="Email / No. Handphone" name="email">
                                <input class="form-control form-control-lg rounded-8 mt-5" type="text" placeholder="Password" name="pass">
